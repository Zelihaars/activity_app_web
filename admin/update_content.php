...
<section class="video-form">
   ...
   <h1 class="heading">Etkinliği güncelle</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>başlığı güncelle <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="etkinlik başlığı" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>açıklamayı güncelle <span>*</span></p>
      ...
      <p>kategoriyi güncelle</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" seç>--kategori seç</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>henüz kategori oluşturulmadı!</option>';
         }
         ?>
      </select>
      <img src="../uploaded_files/<?= $fecth_videos['thumb']; ?>" alt="">
      <p>fotoğrafı güncelle</p>
      <input type="file" name="thumb" accept="image/*" class="box">
      <input type="submit" value="güncelle" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">görüntüle</a>
         <input type="submit" value="sil" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
