...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Yeni kategori eklendi</h3>
         <a href="add_playlist.php" class="btn">Kategori ekle</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">etkinlikleri gör</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">Henüz kategori eklenmedi!</p>';
      }
      ?>
