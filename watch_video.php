...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      if($select_likes->rowCount() > 0){
         ...
         $message[] = 'beğenilerden kaldırıldı';
      }else{
         ...
         $message[] = 'beğenenlere eklendi';
      }

   }else{
      $message[] = 'önce giriş yapın!';
   }
...
<section class="watch-video">
   ...
   <div class="video-details">
       <img src="uploaded_files/<?= $fetch_content['thumb']; ?>" class="video" alt="">
      <h3 class="title"><?= $fetch_content['title']; ?></h3>
      <div class="info">
         <p><i class="fas fa-calendar"></i><span><?= $fetch_content['date']; ?></span></p>
         <p><i class="fas fa-heart"></i><span><?= $total_likes; ?> beğeni</span></p>
      </div>
      <div class="tutor">
      ...
      <form action="" method="post" class="flex">
         ...
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>beğenildi</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="far fa-heart"></i><span>beğen</span></button>
         <?php
            }
         ?>
      </form>
   ...
   <?php
         ...
         echo '<p class="empty">henüz bir şey eklenmedi</p>';
      }
   ?>
...
<section class="comments">
   ...
   <h1 class="heading" style="color: white">yorum ekle</h1>

   <form action="" method="post" class="add-comment">
      <input type="hidden" name="content_id" value="<?= $get_id; ?>">
      <textarea name="comment_box" required placeholder="bir şeyler yaz..." maxlength="1000" cols="30" rows="10"></textarea>
      <input type="submit" value="yorum ekle" name="add_comment" class="inline-btn">
   </form>

   <h1 class="heading" style="color: white">kullanıcı yorumları</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">yorumu güncelle</button>
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');">yorumu sil</button>
         </form>
         <?php
         }
         ?>
      ...
      <?php
         ...
         echo '<p class="empty" style="color: #8e44ad">henüz yorum yok !</p>';
      }
      ?>
      </div>
