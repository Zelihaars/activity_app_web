...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
               <p>eski şifre</p>
               <input type="password" name="old_pass" placeholder="eski şifryi girin" maxlength="50" class="box">
               <p>yeni şifre</p>
               <input type="password" name="new_pass" placeholder="yeni şifreyi girin" maxlength="50" class="box">
               <p>şifre tekrarı</p>
               <input type="password" name="cpass" placeholder="yeni şifreyi tekrar girin" maxlength="50" class="box">
         </div>
      </div>
