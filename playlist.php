...
<section class="playlist">
   ...
   <h1 class="heading" style="color: #ffffff">Kategori Detayı </h1>
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>kayıtlı</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>kaydet</span></button>
            <?php
               }
            ?>
         </form>
         <div class="thumb">
            <span><?= $total_videos; ?> etkinlik</span>
      ...
      <div class="col">
         ...
         <div class="details">
            ...
            <div class="date"><i class="fas fa-calendar"></i><span>Paylaşım Tarihi: <?= $fetch_playlist['date']; ?></span></div>
         </div>
      </div>

      <?php
         }else{
            echo '<p class="empty">Bu kategoriye ait etkinlik şuan yok</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <h1 class="heading" style="color: white">Kategori Etkinlikleri</h1>
   ...
   <div class="box-container">
      ...
      <a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>" class="box">
         ...
         <h3><?= $fetch_content['title']; ?> Etkinliği </h3>
      </a>
      <?php
            }
         }else{
            echo '<p class="empty">bu kategoriye ait henüz etkinlik yok!</p>';
         }
      ?>
